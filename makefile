...
SRC		= ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isprint.c ft_memchr.c\
		...
		ft_putnbr_fd.c ft_putchar_fd.c ft_substr.c ft_strjoin.c ft_strtrim.c ft_strmapi.c ft_split.c ft_lstnew.c ft_lstsize.c\
		ft_lstlast.c ft_lstadd_front.c ft_lstdelone.c ft_lstadd_back.c
OBJ		= $(SRC:.c=.o)
CC		= gcc
RM		= rm -f
